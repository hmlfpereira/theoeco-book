...
As explained above, this data frame contains data on individuals *A. cristatellus* living in urban and forested areas in three cities in Puerto Rico, giving us the perfect opportunity to assess the potential thermal effects of habitat upon this species. To do this:
    ...
    **Hint:** to filter the data you can use the `subset` function in R
    ...
    b. Is there a habitat where lizards are consistently warmer? If so, provide an ecological explanation for this observation (assume an ambient temperature of 30 °C).
