---
title: "Anolis Lizards Ecophisiology"
...
df <- read.csv("/Users/andresmarmolguijarro/Library/Caches/R/rdryad/10_5061_dryad_h234n/winchell_evol_phenshifts.csv")
...
4.  ***Differences in habitats***

As explained above this data frame contains data on individuals *A. cristatellus* living in urban and forested areas from three cities in Puerto Rico, giving us the perfect opportunity to assess potential thermal effects of habitat upon this species. To do this:

a\. Make a linear model for individuals of *A. cristatellus* living only in natural habitats (`context` = `natural`) and another for individuals living in urban habitats (`context` = `urban`).
...
b\. Is there an habitat where lizards are consistently warmer? If so, provide an ecological explanation for this observation.

c\. Is your model appropriate to explain your data?
