...
#| message: false
library(Ryacas)
A=ysym("Integrate(r, 0, r_c) a * Pi * r")
A
```
...
```{r}
#| output: asis
tp=ysym("Integrate(r, 0, r_c) (2 * r / v) * (a * Pi * r) / A")
...
Let's plot the energy per time as a function of the territory size. This time, as we have some
